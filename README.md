...
Additionally, there are some internal implementation differences in the parser and in semantic analysis. These differences don't impact programmers using Decaf. If you're interested to read about these changes, they're in the Decaf [ScalaDoc API documentation](https://github.com/hawkw/decaf#generating-documentation).
